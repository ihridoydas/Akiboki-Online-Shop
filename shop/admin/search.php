...
$search_query="select * from web_deve where id like '%$search_id'";
...
echo "<tr><td><h3 class='colorbind'>Customer ID :</td></h3><td>".$search_row['id']."<a href='delete.php?id=".$search_row['id']."'>Delete</a></td>";
echo "<tr><td><h3 class='colorbind'> Full Name :</td></h3><td>".$search_row['fname']."</td>";
echo "<tr><td><h3 class='colorbind'> User Name :</td></h3><td>".$search_row['uname']."</td>";
echo "<tr><td><h3 class='colorbind'> Email :</td></h3><td>".$search_row['email']."</td>";
echo "<tr><td><h3 class='colorbind'> Password :</td></h3><td>".$search_row['pass']."</td>";
echo "<tr><td><h3 class='colorbind'> Mobile :</td></h3><td>".$search_row['mobile']."</td>";
echo "<tr><td><h3 class='colorbind'> Address :</td></h3><td>".$search_row['address']."</td>";
echo "<tr><td><h3 class='colorbind'> Work Details :</td></h3><td>".$search_row['work']."</td>";
echo "<tr><td><h3 class='colorbind'> Comment :</td></h3><td>".$search_row['comment']."</td>";
echo "<tr><td><h3 class='colorbind'> Order Date :</td></h3><td>".$search_row['sub_date']."</td>";
echo "<tr><td><h3 class='colorbind'> National ID :</td></h3><td>".$search_row['nid']."</td>";
