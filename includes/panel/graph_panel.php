...
<form method="post" action="responce.php" enctype="multipart/form-data">
 ...
 <h2>Order Information</h2>
				  <p style="color:red">Hint: What kind of Graphics Design you want to make ? </p>
				<div class="form-row">
				  <label style="color:white">Graphics Design</label>
			...
			<div class="form-row">
				 	<p style="color:silver; font-size:10px">Hint: You can build your Graphics Design for the convenience </p><p style="color:silver;font-size:10px">some important files you can send. So you can send this via e-mail.</p>	
...
<img src="image/arrow.png" class="graph_flip1"/>
</div>