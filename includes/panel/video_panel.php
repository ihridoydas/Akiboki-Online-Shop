...
<form method="post" action="responce.php" enctype="multipart/form-data">
 ...
 <h2>Order Information</h2>
				  <p style="color:red">Hint: What kind of Video Animation you want to make ? </p>
				<div class="form-row">
				  <label style="color:white">Video Animation</label>
					  <select name="work" required>
				  <option selected style="cursor:not-allowed"></option>
			
				  <option>Static Video Animation</option>
				  <option>Official Video Animation</option>
				  <option>Others Video Animation</option>
				  </select>
		
				</div>
			<div class="form-row">
				 	<p style="color:silver; font-size:10px">Hint: You can build your Video Animation for the convenience </p><p style="color:silver;font-size:10px">some important files you can send. So you can send this via e-mail.</p>	
...
<img src="image/arrow.png" class="video_flip1"/>
</div>